...
def plot_nodes(ns, atlas, filename=None, thr=None, closeplot=False, node_cmap=get_cmap('jet'), display_mode="ortho", figure=None, axes=None, title=None, min=None, max=None):
    """
    ...
    plot_markers(ns, coord, node_threshold=thr, node_cmap=node_cmap, display_mode=display_mode, node_vmin=min, node_vmax=max )#, figure=figure, axes=axes, title=title)
