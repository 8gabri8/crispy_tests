...
pos_0 = axes[0].imshow(np.abs(E_all-Ydiff), interpolation='nearest', vmin=0, vmax=1); axes[0].set_title("abs(E_all-Ydiff)")
pos_1 = axes[1].imshow(np.abs(E_few-Ydiff), interpolation='nearest', vmin=0, vmax=1); axes[1].set_title("abs(E_few-Ydiff)")
plt.tight_layout()
